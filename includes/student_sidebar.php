...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        <li><a href="../dashboard/student_dashboard.php" ><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
            <li><a href="../courses/courses.php"><i class="fas fa-book"></i> <span>Courses</span></a></li>
