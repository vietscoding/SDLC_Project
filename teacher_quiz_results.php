...
// Lấy danh sách các quiz của khóa học giáo viên phụ trách
$result = $conn->query("
...
<head>
    <meta charset="UTF-8">
    <title>Student Quiz Results | [Your University Name]</title>
...
footer{
        ...
        .dark-mode .results-table tbody tr:nth-child(even) {
            background-color: #343a40;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="teacher_quiz_results.php" class="active"><i class="fas fa-chart-bar"></i> View Quiz Results</a></li>
