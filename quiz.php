...
<head>
    <meta charset="UTF-8">
    <title>Take Quiz: <?= htmlspecialchars($quiz_title) ?> | [Your University Name]</title>
        ...
        <form method="post">
            <?php while($row = $result->fetch_assoc()): ?>
                <fieldset>
                    ...
                    <label><input type="radio" name="answer[<?= $row['id'] ?>]" value="B" required> <?= htmlspecialchars($row['option_b']) ?></label><br>
                    <label><input type="radio" name="answer[<?= $row['id'] ?>]" value="C" required> <?= htmlspecialchars($row['option_c']) ?></label><br>
                    <label><input type="radio" name="answer[<?= $row['id'] ?>]" value="D" required> <?= htmlspecialchars($row['option_d']) ?></label><br>
                </fieldset>
                <br>
            <?php endwhile; ?>
