...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dark-mode .quiz-list-header {
            background: linear-gradient(90deg, #2563eb 0%, #1e293b 100%);
        }
        .dark-mode .quiz-list-container {
            background: none;
        }
        .dark-mode .quiz-item {
            background-color: #1e293b;
        ...
        .dark-mode .quiz-item a {
            color: #fbbf24;
            background: #1e293b;
            border: 1px solid #fbbf24;
        }
        .dark-mode .quiz-item a:hover {
            background: #fbbf24;
            color: #1e293b;
        }
        ...
        @media (max-width: 992px) {
            ...
            .quiz-list-header h2 { font-size: 1.8em; }
        }
        @media (max-width: 768px) {
            ...
            .quiz-list-header { flex-direction: column; align-items: flex-start; }
            .quiz-list-header h2 { margin-bottom: 10px; font-size: 1.8em; }
        }
