...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($content)) {
        // Lấy danh sách user_id theo role
        if ($target_role === 'all') {
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .send-notification-header h2 i {
            margin-right: 10px;
            color: #007bff; /* Blue for notification */
        }
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="admin_send_notification.php" class="active"><i class="fas fa-bell"></i> Post Notifications</a></li>
    ...
    <div class="notification-form-container">
        ...
        <form method="post">
            <div class="form-group">
                <label for="content"><i class="fas fa-envelope"></i> Notification Content:</label><br>
                <textarea id="content" name="content" rows="4" cols="50" required></textarea>
            </div>

            <div class="form-group">
                <label for="target_role"><i class="fas fa-users"></i> Send To:</label><br>
