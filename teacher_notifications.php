...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .notification-form-container select:focus,
        .notification-form-container textarea:focus {
            border-color: #f1c40f;
        ...
        .dark-mode .notification-form_container label {
            color: #ccc;
        }
        ...
        .dark-mode .notification-form-container select:focus,
        .dark-mode .notification-form-container textarea:focus {
            border-color: #f39c12;
        ...
        .dark-mode .notification-form-container button[type="submit"]:hover {
            background: linear-gradient(90deg, #28a745 0%, #6dd5fa 100%);
            color: #fff;
        }
        .dark-mode .notification-sent-success {
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="teacher_notifications.php" class="active"><i class="fas fa-bell"></i> <span>Send Notifications</span></a></li>
