...
<head>
    <meta charset="UTF-8">
    <title>Search Courses | [Your University Name]</title>
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="student_search_courses.php" class="active"><i class="fas fa-search"></i> Search Courses</a></li>
                ...
                <ul>
                    <?php while ($course = $result->fetch_assoc()): ?>
                        <li>
                            ...
                            <br>
                            <a href="course_detail.php?course_id=<?= $course['id'] ?>">View Details</a>
                        </li>
                    <?php endwhile; ?>
                </ul>
            <?php else: ?>
