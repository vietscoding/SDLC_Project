...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['title']) && isset($_POST['content'])) {
    ...
    if (!empty($title) && !empty($content)) {
        $stmt = $conn->prepare("INSERT INTO lessons (course_id, title, content, video_link) VALUES (?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Manage Lessons - <?= htmlspecialchars($course_title) ?> | [Your University Name]</title>
      ...
      /* Reset some default styles */
        *, *::before, *::after {
        ...
        .lesson-item {
            ...
            justify-content: space-between;
            align-items: center;
            border-left: 3px solid #f39c12; /* Teacher-specific light accent */
        }
        ...
        .lesson-actions .edit-btn {
            color: #2980b9; /* Info blue */
        }
       ...
       footer{
        ...
        .dark-mode .lesson-list-section .lesson-item {
            background-color: #444;
            border-left-color: #f39c12;
            color: #eee;
        }
        ...
        .dark-mode .lesson-actions .edit-btn {
            color: #3498db;
        }
   ...
   <div class="sidebar">
    ...
    <div class="main-content">
        <div class="lessons-header">
            <h2>Manage Lessons for Course: <?= htmlspecialchars($course_title) ?></h2>
            <div>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <li class="lesson-item">
                            ...
                            <div class="lesson-actions">
                                <a href="edit_lesson.php?course_id=<?= $course_id ?>&lesson_id=<?= $row['id'] ?>" class="edit-btn" title="Edit Lesson"><i class="fas fa-edit"></i></a>
                                <a href="teacher_lessons.php?course_id=<?= $course_id ?>&remove_id=<?= $row['id'] ?>" onclick="return confirm('Remove this lesson?')" title="Remove Lesson"><i class="fas fa-trash-alt"></i></a>
                            </div>
                        </li>
                    <?php endwhile; ?>
                </ul>
        ...
        <div class="navigation-links">
            ...
            <a href="teacher_logout.php"><i class="fas fa-sign-out-alt"></i> Log Out</a>
        </div>
