...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .dark-mode .user-info-container p {
            color: #ccc;
        }

        .dark-mode .edit-user-form-container {
            background-color: #343a40;
            color: #eee;
            box-shadow: 0 1px 5px rgba(0, 0, 0, 0.3);
        }
...
<div class="main-content">
    ...
    <div class="user-info-container">
        <p><i class="fas fa-user"></i> <strong>Full Name:</strong> <?= htmlspecialchars($fullname) ?></p>
    ...
    <div class="back-link">
        <a href="admin_users.php"><i class="fas fa-arrow-left"></i> Back to Users</a>
    </div>
