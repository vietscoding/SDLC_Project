...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="student_view_assignments.php" class="active"><i class="fas fa-check-circle"></i> <span>Grades & Results</span></a></li>
                            ...
                            <li class="assignment-item">
                                ...
                                <?php if ($a['submitted_text'] || $a['submitted_file']): /* */ ?>
                                    ...
                                    <div class="grade-feedback">
                                        <strong>Grade:</strong>
                                        <span class="grade-value"><?= $a['grade'] !== null ? $a['grade'] : '<span class="no-grade">Not graded yet</span>' ?></span><br>
